...
public class ZkFileSystemConfigBuilder extends FileSystemConfigBuilder {
  ...
  private static final ZkFileSystemConfigBuilder BUILDER = new ZkFileSystemConfigBuilder();
  ...
  public void setCuratorFramework(final FileSystemOptions opts, final CuratorFramework curatorFramework) {
  ...
  public RetryPolicy getRetryPolicy(final FileSystemOptions opts) {
    if (!hasParam(opts, KEY_RETRY_POLICY)) {
      setParam(opts, KEY_RETRY_POLICY, new ExponentialBackoffRetry(getRetryTimeout(opts),
          getRetryRetries(opts)));
    }
  ...
  public void setRetryRetries(final FileSystemOptions opts, final int retryCount) {
  ...
  public void setSessionTimeout(final FileSystemOptions opts, final int timeout) {
  ...
  public void setZkConnectionString(final FileSystemOptions opts, final String serverName) {
  ...
  public void setZkNamespace(final FileSystemOptions opts, final String namespace) {
  ...
  public void setZkAuthScheme(final FileSystemOptions opts, final String userName) {
